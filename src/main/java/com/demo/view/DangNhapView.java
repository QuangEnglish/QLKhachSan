...
import com.demo.controller.DangNhapController;
import com.demo.dao.TaiKhoanDao;
...
public class DangNhapView extends JFrame {
  ...
  public void dangNhap() {
    ...
    if (txtTaiKhoan.getText().isEmpty() || txtMatKhau.getText().isEmpty()) {
      JOptionPane.showMessageDialog(rootPane, "Bạn không được để trống tài khoản mật khẩu",
          "Thông báo", JOptionPane.INFORMATION_MESSAGE);
      return;
    }
    TaiKhoan dstk = TaiKhoanDao.getInstance().getTk(txtTaiKhoan.getText().trim());
    if (dstk != null && txtMatKhau.getText().equals(dstk.getMatKhau())) {
