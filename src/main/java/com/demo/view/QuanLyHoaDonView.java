...
import com.demo.controller.QuanLyHoaDonController;
import com.demo.dao.HoaDonDao;
import com.demo.dao.KhachHangDao;
import com.demo.dao.PhongDao;
...
public class QuanLyHoaDonView extends JFrame{
	...
	public static QuanLyHoaDonView getInstance() throws SQLException {
	...
	public QuanLyHoaDonView() throws SQLException {
	...
	public void HienThiData(ArrayList<HoaDon> dshd) throws SQLException {
		int n = dshd.size();
		data = new String[n][6];
		int index = 0;
		for(HoaDon hd : dshd) {
	...
	public void Xem(QuanLyHoaDonView quanLyHoaDonView) throws SQLException {
		String soPhong = "";
	...
	public void ThemHoaDon(QuanLyHoaDonView quanLyHoaDonView) throws SQLException {
		String ngayTra = "";
...
//		soHD = textField.getText();
	...
	public void InHoaDon(QuanLyHoaDonView quanLyHoaDonView) throws SQLException {
