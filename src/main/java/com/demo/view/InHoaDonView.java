...
import com.demo.controller.InHoaDonController;
...
public class InHoaDonView  extends JFrame{
	...
	public InHoaDonView(String[][] dt) throws SQLException {
	...
	public void InHoaDon(InHoaDonView inHoaDonView) throws SQLException {
		Phong phong = phongDao.SelectPhongByID(data[0][2]);
