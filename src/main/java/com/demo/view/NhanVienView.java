...
import com.demo.controller.NhanVienController;
...
public class NhanVienView extends JFrame {
	...
	public void ThemNhanVien() throws SQLException {
		if(checkNull()) {
	...
	public void SuaNhanVien() throws SQLException {
		if(checkMaNV() == false) {
			JOptionPane.showMessageDialog(rootPane, "Mã nhân viên không tồn tại", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
			return;
		}
...
//		nv.setSDT(txtSDT.getText());
	...
	public void timNhanVien() throws SQLException {
		// TODO Auto-generated method stub
